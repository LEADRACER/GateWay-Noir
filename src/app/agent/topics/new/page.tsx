...
import { CreateTopicForm } from "@/app/admin/topics/new/CreateTopicForm";
...
export default async function NewAgentTopicPage() {
  ...
  return (
    <div>
      <div className="case-file rounded-2xl p-5 mb-6">
        ...
        <p className="text-sm text-zinc-500">Submit a case for bureau review</p>
      </div>

      <div className="max-w-2xl">
        <div className="case-file rounded-2xl p-6">
          <CreateTopicForm categories={categories} canCreateActive={false} />
        </div>
      </div>
    </div>
  );
